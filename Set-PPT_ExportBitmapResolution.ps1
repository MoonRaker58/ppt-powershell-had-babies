<#
.SYNOPSIS
    Set-PPT_ExportBitmapResolution is a way to change the resolution of PowerPoint's Export of slides as Bitmap images.
.DESCRIPTION
    Set-PPT_ExportBitmapResolution changes the resolution of PowerPoint's export of slides as Bitmap images, including the ability to reset to default. This affects the right click and "Save As Picture" option as well as the File > Save As option when the file format is a bitmap image type like jpeg, png, bmp.
...
.EXAMPLE
    Set-PPT_ExportBitmapResolution 100
...
#>
function Set-PPT_ExportBitmapResolution {
    [CmdletBinding()]
    [OutputType([string])]
    param(
